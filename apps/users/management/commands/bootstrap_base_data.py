...
class Command(BaseCommand):
    ...
    def _upsert_schedules(self):
        ...
        daily_10_00, _ = CrontabSchedule.objects.get_or_create(**CRONTAB_DATA[1])
        each_3_hours, _ = IntervalSchedule.objects.get_or_create(**INTERVAL_DATA)
        return {
            "daily_04_00": {"crontab": daily_04_00, "interval": None},
            "daily_10_00": {"crontab": daily_10_00, "interval": None},
